...
componentDidMount() {
    //console.log(Math.ceil(this.props.productList.articlesList.pagetotal/5));
	//console.log(this.props.productList.articlesList.pagetotal);
}
	  ...
	  return(
		  ...
		  <Grid>
		    <Row>
               <Col md={10}>
			     <div>
			      <Select loadArticles={this.props.loadArticles} activePage={this.state.activePage}  url="/routertoursproductlist.json"/>
			     </div>
...
export default connect(state => {
   return {
      productList:state.tours.productList,

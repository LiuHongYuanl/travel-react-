...
import * as Styles from './ScenicSpot.scss';
import { Grid, Row, Col, Pagination } from 'react-bootstrap';

import { push } from 'react-router-redux';
import { connect } from 'react-redux';
import { bindActionCreators } from 'redux';
import { loadArticles } from './ScenicSpotRedux'; 
	  ...
	  return(
		  ...
		  <Grid>
		    <Row>
               <Col md={10}>
			     <div>
			    <Select city={true} loadArticles={this.props.loadArticles} activePage={this.state.activePage}  url="/routerscenicspotproductlist.json"/>
			     </div>
...
export default connect(state => {
   return {
      productList:state.scenicspot.productList,

	...
	render() {
	  return(
		  ...
		  <Grid>
		   ...
		   <Select loadArticles={this.props.loadArticles} activePage={this.state.activePage}  url="/routerlinerproductlist.json"/>
			     </div>
...
export default connect(state => {
   return {
      productList:state.liner.productList,
